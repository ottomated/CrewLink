...
import Settings, { ILobbySettings, ISettings, lobbySettingsReducer, settingsReducer } from './Settings';
			...
			<LobbySettingsContext.Provider value={lobbySettings}>
				<SettingsContext.Provider value={settings}>
					<div className="titlebar">
						...
						<svg className="titlebar-button refresh" width="20px" height="20px" viewBox="0 0 512 512"  fill="#868686" enableBackground="new 0 0 24 24" onClick={() => {remote.getCurrentWindow().reload();}}>
							<g>
