	...
	return (
		<Tooltip useHover={!player.isLocal} content={player.name} padding={5}>
			...
			<div className="slidecontainer">
				<input type="range" min="0" max="2" className="relativeGainSlider" step="any" onInput={(ev): void => console.log("thing happened")} onChange={(ev): void => {
					player.relativeGain = parseFloat(ev.target.value);
					console.log(parseFloat(ev.target.value));
					console.log("Thing"); //Delete these logs once it works
