...
type LobbySettingsContextValue = [ILobbySettings, React.Dispatch<{
	type: 'set' | 'setOne';
...
export const LobbySettingsContext = createContext<LobbySettingsContextValue>(null as unknown as LobbySettingsContextValue);